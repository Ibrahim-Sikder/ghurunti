          ...
          <div className={style.galleryWraps}>
            <div className={style.galleryleftSide}>
              ...
              <div className="mt-5">
                ...
                <div className="mt-5">
                  <strong>
                    Lowest price guaranteeReserve now & pay laterFree
                    cancellation
                  </strong>
                </div>
                <hr className="my-5" />
                      ...
                      <Typography className={style.accordionTypos}>
                        <div>
                          ...
                          <p>
                            ...
                            Rd, Khulna, Bangladesh
                          </p>
                          <p>
                            Shipbuilding is a growing industry in Bangladesh
                ...
                <div>
                  ...
                  <p>
                    ...
                    below and reference the product code: 90303P1
                  </p>
                  <div className="mt-3">
                    <strong>
