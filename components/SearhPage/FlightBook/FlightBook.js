            ...
            <section>
              <div className={style.bookingReview}>
                ...
                <div className={style.flightSection}>
                  <h6>
                    Flight Selection{" "}
                    <ArrowForwardIos className={style.reviewIcon} />
                  </h6>
                  <h6>
              ...
              <div className={style.dealWrap}>
                <p className={style.mandatory}>
                  *It is mandatory to upload copy of your valid passport and
                  visa
                </p>
              ...
              <div className={style.dealWrap}>
                ...
                <div className={style.hotdetailWrap}>
                  <div className={style.hotDeal}>
                    ...
                    <small>
                      13% discount for EBL Visa credit & debit cards.
                    </small>
                    <br />
                  ...
                  <div className={style.hotDeal}>
                    ...
                    <small>
                      7% discount for Nagad, Rocket, tap & upay payment.
                    </small>
                    <br />
                    <strong>Offer Details </strong>
                  </div>
                  <div className={style.hotDeal}>
                    ...
                    <small>
                      7% discount on flight booking for Pay in Cash.
                    </small>
                    <br />
                    <strong>Offer Details </strong>
                  </div>
                  <div className={style.hotDeal}>
                    ...
                    <small>
                      10% discount for EBL Visa credit & debit cards.
                    </small>
                    <br />
                    <strong>Offer Details </strong>
                  </div>
                ...
                <div className="my">
                  <Accordion className={style.flightBookDetail}>
                    ...
                    >
                      <Typography>
                        <div className="flex items-center">
                          <h6 className="text-[#4AB449] font-sm">
                            Passenger 1{" "}
                          </h6>{" "}
                      ...
                      <Typography>
                        ...
                        <div className="mt-10">
                          ...
                          <div className="mb-5 mt-14">
                            <small>
                              By adding travel insurance policy, you are
            ...
            <div className={style.rightSide}>
              <div className={style.rightSideWrap}>
                ...
                <div className={style.payment}>
                  ...
                  />
                  <p>
                    I aggree to the <strong>Terms & Condition</strong> and{" "}
                    <strong>Privacy Policy</strong>{" "}
                  </p>
                </div>
                <Link href="/flight/book">
                  {" "}
                  <input
                    disable={disabled}
