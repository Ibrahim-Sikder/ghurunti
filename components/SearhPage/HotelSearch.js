            ...
            <div className={style.availableHotel}>
              ...
              >
                ...
                <button
                  className={
                    highPrice
                      ? "bg-[#19ABE3] text-white px-3  rounded-md py-2  btn-sm"
                      : "bg-white text-[#19ABE3] px-3 rounded-md border border-[#19ABE3]  py-2  btn-sm"
                  }
                    ...
                    <CardContent>
                      ...
                      >
                        ...
                        <div>
                          <Checkbox />
                          <span>
                            Travel Sustainable properties Properties taking
                            steps to make your stay more sustainable{" "}
                          </span>
                        </div>
                      </Typography>
                    </CardContent>
